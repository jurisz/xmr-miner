...
int main(void) {
    const static char input[] = "0606e385b3d205f0be8b4c675d12594342ff9a12f720045f83d80ee63c470dc0fda190c8f961f400000000a586944abf4beab24b212a42c0c6fd00c4429984d8ca8391ab00456541f230c514d63e72ab"; 
    
    struct cryptonight_ctx *ctx = (struct cryptonight_ctx*) create_ctx(1);
    
    cryptonight_av1_aesni(input1, 76, &hash, ctx);
    
    cout << bin2hex(hash, 32);
